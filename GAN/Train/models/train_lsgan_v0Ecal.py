...
if __name__ == '__main__':
    ...
    from architectures import build_generator_3D, build_discriminator_3D, build_regression, build_discriminator_3D_v1, build_discriminator_3D_v2 ,build_discriminator_3D_v3, build_discriminator_3D_H_v0, build_generator_3D_v1, build_generator_3D_H_v1
...
###################################
    ...
    combined_outputs = [discriminator( [generator(generator_inputs)[0], generator(generator_inputs)[2] ]), reg_model( [ generator(generator_inputs)[0],generator(generator_inputs)[1], generator(generator_inputs)[3] ] ) ]
    print('h31')
    ...
    for epoch in range(nb_epochs):
        ...
        for ib in range(len(Batch)):
            ...
            for index in range(ibatch):
                ...
                if real_batch_loss > 1000:
                    epoch_disc_loss_real[str(Data[ib])]={index:real_batch_loss}
                    print('real_batch_loss=',real_batch_loss,':',str(Data[ib]),':',index,':', info_batch,':',np.sum(image_batch))
                fake_batch_loss = discriminator.train_on_batch(
                    #[generated_images[0], generated_images[1], generated_images[2]], 
                    [generated_images[0], generated_images[2]], 
                    disc_outputs_fake,
                    loss_weights          
                )
                ...
                if ( ib == (len(Batch)-1) ) and ( index == (ibatch-1) ):
                    ...
                    fake_pred = discriminator.predict_on_batch([ generated_images[0], generated_images[2] ])
                    print('real_pred:\n',real_pred)
                    print('fake_pred:\n',fake_pred)
                ...
                #epoch_disc_loss_fake.append(fake_batch_loss)
                ...
                while True:
                    ...
                    #combined_outputs = [ np.ones(batch_size), sampled_info[:,0:3] ]
        ...
        print('epoch_disc_loss_real=',epoch_disc_loss_real)
