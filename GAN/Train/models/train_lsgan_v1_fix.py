...
if __name__ == '__main__':
    ...
    from architectures import build_generator_3D, build_discriminator_3D, build_regression, build_discriminator_3D_v1, build_discriminator_3D_v2 ,build_discriminator_3D_v3, build_discriminator_3D_H_v0, build_generator_3D_v1, build_generator_3D_H_v1, build_generator_3D_EHcal
...
###################################
    ...
    #combined_outputs = [discriminator( [generator(generator_inputs)[0], generator(generator_inputs)[1],  generator(generator_inputs)[2] ]), reg_model( [ generator(generator_inputs)[0], generator(generator_inputs)[1], generator(generator_inputs)[3] ] ) ]
        ...
        for ib in range(len(Batch)):
            ...
            for index in range(ibatch):
                ...
                if ( ib == (len(Batch)-1) ) and ( index == (ibatch-1) ):
                    ...
                    real_pred = discriminator.predict_on_batch([image_batch, image_H_batch, info_batch])
                    fake_pred = discriminator.predict_on_batch([ generated_images[0], generated_images[1], generated_images[2] ])
                    print('real_pred:\n',real_pred)
                    print('fake_pred:\n',fake_pred)
                    print('mse real\n:', loss_mse(disc_outputs_real, real_pred))
                    print('mse fake\n:', loss_mse(disc_outputs_fake, fake_pred))
                    print('test on batch real\n:',  discriminator.test_on_batch([image_batch, image_H_batch, info_batch],disc_outputs_real, loss_weights ) )
                    print('test on batch fake\n:',  discriminator.test_on_batch([generated_images[0], generated_images[1], generated_images[2]],disc_outputs_fake, loss_weights) )
