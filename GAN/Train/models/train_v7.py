...
""" 
file: train_v5.py
Using mc info : mom, dtheta, dphi, dz, dy, Z 
Using cell ID
...
if __name__ == '__main__':
    ...
    input_Info = Input(shape=(6, )) ## scaled input !!
...
###################################
    ...
    for epoch in range(nb_epochs):
        ...
        for ib in range(len(Batch)):
            ...
            mc_info_v1_new    = np.concatenate((mc_info_v1_mom, mc_info_v1_dtheta, mc_info_v1_dphi, mc_info_v1_dz, mc_info_v1_dy, mc_info_v1_z),axis=-1)
            ...
            mc_info_v2_new    = np.concatenate((mc_info_v2_mom, mc_info_v2_dtheta, mc_info_v2_dphi, mc_info_v2_dz, mc_info_v2_dy, mc_info_v2_z),axis=-1)
            ibatch = Batch[ib]
